 ...
 */
/**
 * @module emojis/ui/charactergridview
 */
...
/**
 * A grid of character tiles. It allows browsing emojis and selecting the character to
...
export default class CharacterGridView extends View<HTMLDivElement> {
    ...
    /**
     * Creates an instance of a character grid containing tiles representing emojis.
     *
     ...
     * @param name The name of the character (e.g. "Grinning Face").
     */
...
export interface CharacterGridViewEventData {
    /**
     * The name of the tile that caused the event (e.g. "Grinning Face").
     */
    name: string;
    /**
     * A human-readable character displayed as the label (e.g. "😃").
     */
    character: string;
}
