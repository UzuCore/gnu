...
import type Emojisnavigationview from './emojisnavigationview.js';
/**
 ...
 */
export default class EmojisView extends View<HTMLDivElement> {
    /**
     ...
     */
    categoriesView: Emojisnavigationview;
    /**
     ...
     */
    constructor(locale: Locale, categoriesView: Emojisnavigationview, gridView: CharacterGridView, infoView: CharacterInfoView);
    /**
     * @inheritDoc
     */
    render(): void;
