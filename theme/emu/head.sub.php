...
add_javascript('<script src="'.G5_JS_URL.'/jquery-migrate-3.5.0.min.js"></script>', 0);
if (defined('_SHOP_')) {
    if(!G5_IS_MOBILE) {
...
add_stylesheet('<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+KR&display=swap" rel="stylesheet">', 0);
add_stylesheet('<link href="https://fonts.googleapis.com/css?family=Nanum+Gothic&display=swap" rel="stylesheet">', 0);
add_stylesheet('<link href="'.G5_JS_URL.'/font-awesome/css/font-awesome.min.css" rel="stylesheet">', 0);
add_stylesheet('<link href="'.G5_JS_URL.'/remixicon/remixicon.css" rel="stylesheet">', 0);
