...
CREATE TABLE IF NOT EXISTS `g5_member` (
  ...
  `mb_1` text NOT NULL default '',
  `mb_2` text NOT NULL default '',
  `mb_3` text NOT NULL default '',
  `mb_4` text NOT NULL default '',
  ...
  `mb_12` text NOT NULL default '',
  `mb_13` text NOT NULL default '',
  `mb_14` text NOT NULL default '',
  `mb_15` text NOT NULL default '',
  `mb_16` text NOT NULL default '',
  `mb_17` text NOT NULL default '',
  `mb_18` text NOT NULL default '',
  `mb_19` text NOT NULL default '',
  `mb_20` text NOT NULL default '', 
  PRIMARY KEY  (`mb_no`),
